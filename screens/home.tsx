...
const CarouselItem = function ({
  ...
  return (
    ...
    >
      ...
      <Box position="absolute" bottom={0} left={0} right={0} p={1} backgroundColor="trueGray.700" opacity={75}
           borderRadius="6">
        <Text fontSize="md" color="trueGray.100" numberOfLines={1}>{item.title}</Text>
      </Box>
    </Pressable>
  )
}
