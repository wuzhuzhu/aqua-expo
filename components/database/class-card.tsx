...
import {AspectRatio, Box, Text, Image, Center, Stack, Heading, Pressable} from "native-base"
...
const ClassCard = ({classItem, classesName}: IClassCardPropType) => {
  ...
  >
    <Pressable onPress={() => navigation.navigate('Fish', {id: classItem.id, title: classItem.name})}>
      <Box>
